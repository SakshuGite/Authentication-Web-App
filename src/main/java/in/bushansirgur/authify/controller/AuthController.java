...
import in.bushansirgur.authify.io.ResetPasswordRequest;
...
public class AuthController {
    ...
    public void verifyEmail(@RequestBody Map<String, Object> request,
        ...
        if (otpObject == null || otpObject.toString().trim().isEmpty()) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Missing OTP");
        }

        try {
            profileService.verifyOtp(email, otpObject.toString());
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
